...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__setup__ = __webpack_require__(681);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash__ = __webpack_require__(682);
...
var SetupPage = /** @class */ (function () {
    function SetupPage(navCtrl, orderProvider, alertCtrl, navParams) {
        ...
        this.listDataGroup = [];
        this.localFood = new __WEBPACK_IMPORTED_MODULE_2__providers_order_food_order_food__["a" /* CFood */]();
        this.title = "Tạo";
        this.initializeItems();
    }
    SetupPage.prototype.initializeItems = function () {
        var _this = this;
        var data = this.orderProvider.getAllFood().valueChanges().subscribe(function (dataInfo) {
            ...
            if (dataInfo) {
                for (var index = 0; index < dataInfo.length; index++) {
                    var food = new __WEBPACK_IMPORTED_MODULE_2__providers_order_food_order_food__["a" /* CFood */]();
                    food.copy(dataInfo[index]);
                    _this.orderProvider.listFoodObject[food.id] = food;
            ...
            var group = __WEBPACK_IMPORTED_MODULE_3_lodash___default.a.groupBy(dataOfFood, "type");
            for (var index = 0; index < _this.orderProvider.listTypeFood.length; index++) {
                var dataGroup = new __WEBPACK_IMPORTED_MODULE_2__providers_order_food_order_food__["d" /* CTypeFood */]();
                dataGroup.type = _this.orderProvider.listTypeFood[index];
                dataGroup.listData = group[dataGroup.type];
                _this.listDataGroup.push(dataGroup);
            }
        });
    };
    SetupPage.prototype.expandList = function (data) {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(67), __webpack_require__(683)(module)))
