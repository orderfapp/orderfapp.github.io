...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__setup__ = __webpack_require__(523);
    ...
    SetupPage.prototype.initializeItems = function () {
        ...
        var data = this.orderProvider.getAllFood().valueChanges().subscribe(function (dataInfo) {
            ...
            for (var index = 0; index < _this.orderProvider.listTypeFood.length; index++) {
                var dataGroup = new __WEBPACK_IMPORTED_MODULE_2__providers_order_order__["b" /* CTypeFood */]();
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(67), __webpack_require__(525)(module)))
